    ...
    <div className={`flex items-center gap-3 select-none ${className}`}>
      ...
      {showText && (
        <div className="flex items-center gap-2">
          ...
          <span className="text-[10px] font-extrabold uppercase px-1.5 py-0.5 rounded bg-gradient-to-r from-pink-500/25 to-rose-500/20 text-cyan-300 border border-cyan-400/30">
            PRO
          </span>
        </div>
      )}
