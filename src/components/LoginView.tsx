    ...
    <div className="login-view min-h-screen flex items-center justify-center p-5 sm:p-8 bg-slate-950">
      ...
      >
        ...
        <div className="text-center space-y-2">
          <div className="inline-flex items-center gap-2 rounded-full border border-pink-400/20 bg-pink-400/10 px-3 py-1 text-[10px] font-black uppercase tracking-[0.18em] text-pink-300">
        ...
        {needsAccessCode && (
          <label className="access-code-field block rounded-2xl border border-pink-400/20 bg-pink-400/[0.06] p-4 text-xs font-bold text-slate-200">
        ...
        <label className="block text-xs font-bold text-slate-300">
          ...
          <span className="mt-3 flex items-center gap-4 rounded-2xl border border-white/10 bg-white/[0.03] p-3">
            <span className="flex h-16 w-16 shrink-0 items-center justify-center overflow-hidden rounded-full bg-gradient-to-br from-pink-500 to-rose-700 text-xl font-black text-white shadow-[0_0_24px_rgba(255,45,122,.24)]">
              {photo ? (
        ...
        <button className="w-full rounded-xl bg-gradient-to-r from-pink-500 to-rose-700 py-4 font-black text-white">
