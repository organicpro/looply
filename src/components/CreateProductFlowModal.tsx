  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 md:p-6 bg-slate-950/85 backdrop-blur-2xl overflow-y-auto">
      <motion.div
        ...
        className="create-flow-modal glass-panel w-full max-w-5xl rounded-[2.8rem] overflow-hidden shadow-[0_25px_70px_rgba(0,0,0,0.9)] border border-white/20 my-auto relative"
      >
        {/* Glow Accent Header line with Cyan & Pink Chromatic Aberration */}
        <div className="absolute top-0 left-0 right-0 h-[3px] bg-gradient-to-r from-[#fb923c] via-orange-500 to-[#ea580c] shadow-[0_0_20px_rgba(255,45,122,0.65)]" />
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <div className="flex items-center gap-2">
                <span className="text-[10px] font-bold text-orange-300 uppercase tracking-widest bg-gradient-to-r from-[#fb923c]/20 to-[#ea580c]/20 border border-orange-400/30 px-2.5 py-0.5 rounded-full">
            ...
            >
              ...
              <div className="bg-white/[0.03] border border-white/10 rounded-[2rem] p-6 md:p-8 flex flex-col md:flex-row items-center justify-between gap-6 hover:border-white/20 transition-all shadow-inner relative overflow-hidden group">
                <div className="flex items-center gap-5 w-full md:w-auto">
                  <div className="w-14 h-14 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center text-slate-300 group-hover:text-orange-300 group-hover:bg-orange-500/10 transition-all shrink-0">
                  ...
                  {isUploadingCustom ? (
                    <div className="flex items-center gap-2 w-full md:w-auto">
                      <input
                        ...
                        className="bg-slate-900 border border-white/20 rounded-xl px-4 py-2.5 text-sm text-white placeholder-slate-500 focus:outline-none focus:border-orange-500 w-full md:w-60"
                      />
                      <label className="cursor-pointer bg-gradient-to-r from-orange-500 to-amber-500 text-white font-bold px-4 py-2.5 rounded-xl text-xs hover:opacity-90 whitespace-nowrap">
                        Enviar Foto
                    ...
                    >
                      <Plus className="w-4 h-4 text-orange-400" /> + adicionar
                    </button>
                  )}
                </div>
              </div>
                  ...
                  return (
                    <div
                      ...
                      className={`relative rounded-[2rem] overflow-hidden cursor-pointer transition-all duration-300 flex flex-col group ${
                        isSelected
                          ? 'bg-gradient-to-b from-orange-500/20 to-slate-900/90 border-2 border-orange-500 shadow-[0_0_25px_rgba(249,115,22,0.35)] scale-[1.02]'
                    ...
                    >
                      ...
                      <div className="aspect-[4/3] w-full relative overflow-hidden bg-slate-900/80">
                        ...
                        <div className="absolute top-2.5 left-2.5 flex items-center gap-1.5">
                          <span className={`text-[9px] md:text-[10px] font-bold px-2.5 py-1 rounded-xl shadow-md border ${
                            prod.badgeType === 'viral'
                              ? 'bg-orange-600/90 border-orange-400 text-white shadow-[0_0_10px_rgba(249,115,22,0.6)]'
                        ...
                        {isSelected && (
                          <div className="absolute bottom-2 left-1/2 -translate-x-1/2 bg-orange-500 text-white rounded-full p-1.5 shadow-[0_0_15px_rgba(249,115,22,0.8)] border border-white/40">
              ...
              <div className="flex justify-end pt-6 border-t border-white/10">
                <button
                  ...
                  className="px-10 py-4 bg-gradient-to-r from-orange-500 to-amber-500 hover:opacity-95 text-white font-bold text-base rounded-full shadow-[0_0_25px_rgba(249,115,22,0.4)] border border-white/20 transition-all hover:scale-105 active:scale-95 flex items-center gap-3 disabled:opacity-40"
                >
          ...
          {step === 2 && (
            ...
            >
              ...
              <div className="bg-white/[0.04] backdrop-blur-xl border border-white/10 rounded-2xl p-4 flex items-center justify-between">
                ...
                <button
                  onClick={() => setStep(1)}
                  className="text-xs font-bold text-orange-400 hover:text-white transition-colors underline"
                >
                  Trocar Produto
                </button>
              </div>
                    ...
                    return (
                      <button
                        ...
                        className={`p-5 rounded-2xl flex flex-col items-center justify-center text-center gap-3 transition-all duration-300 min-h-[120px] ${
                          isSelected
                            ? 'bg-[#1f1008] border-2 border-orange-500 shadow-[0_0_20px_rgba(249,115,22,0.35)] text-orange-400 scale-105'
                            : 'bg-white/[0.04] backdrop-blur-xl border border-white/10 hover:bg-white/10 text-slate-300 hover:text-white'
                        }`}
                      >
                        <IconComponent className={`w-7 h-7 ${isSelected ? 'text-orange-400' : 'text-slate-400'}`} />
                        <span className={`text-xs md:text-sm font-bold leading-tight ${isSelected ? 'text-orange-300' : 'text-slate-200'}`}>
                          {scen.title}
                        </span>
                      </button>
                    );
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-5 pt-2">
                ...
                <div className="space-y-2">
                  ...
                  <select
                    ...
                    className="w-full bg-white/[0.05] border border-white/15 rounded-xl px-4 py-3 text-sm text-white focus:outline-none focus:border-orange-500"
                  >
              ...
              <div className="flex items-center justify-between pt-6 border-t border-white/10">
                ...
                <button
                  ...
                  className="px-10 py-4 bg-gradient-to-r from-orange-500 via-amber-500 to-amber-500 hover:opacity-95 text-white font-bold text-base rounded-full shadow-[0_0_30px_rgba(249,115,22,0.5)] border border-white/30 transition-all hover:scale-105 active:scale-95 flex items-center gap-3"
                >
              ...
              {isGenerating ? (
                ...
                <div className="py-16 flex flex-col items-center justify-center text-center space-y-6">
                  <div className="relative w-24 h-24">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-br from-orange-500 to-amber-600 rounded-full flex items-center justify-center border border-white/30 shadow-[0_0_30px_rgba(249,115,22,0.6)]">
                  ...
                  <div className="space-y-2 max-w-md">
                    ...
                    <p className="text-slate-300 text-sm">
                      Combinando produto <span className="text-orange-300 font-bold">{selectedProduct?.name}</span> no cenário <span className="text-orange-300 font-bold">{activeScenarioObj.title}</span>.
                    </p>
                  </div>
                  ...
                  <div className="w-full max-w-md bg-white/10 h-3 rounded-full overflow-hidden border border-white/20">
                    <motion.div
                      className="bg-gradient-to-r from-orange-500 via-amber-500 to-amber-400 h-full rounded-full shadow-[0_0_15px_rgba(249,115,22,0.8)]"
                      style={{ width: `${generationProgress}%` }}
                    />
                  </div>
                  <span className="text-xs font-mono text-orange-300 font-bold">{generationProgress}% concluído</span>
                </div>
              ) : (
                ...
                <div className="grid grid-cols-1 lg:grid-cols-[340px_1fr] gap-8 items-start">
                  ...
                  <div className="generated-video-preview relative aspect-[9/16] w-full max-w-[340px] mx-auto rounded-[2.5rem] overflow-hidden bg-slate-950 border-4 border-slate-800 shadow-[0_20px_50px_rgba(0,0,0,0.8)] group">
                    ...
                    {isSpecialKettleMarble ? (
                        ...
                        <div className="relative w-full h-full overflow-hidden bg-slate-900">
                          ...
                          <div className="absolute inset-0 flex flex-col items-center justify-center p-4">
                            <div className="relative w-56 h-56 rounded-full bg-white/10 backdrop-blur-md border border-white/30 flex items-center justify-center p-2 shadow-2xl">
                              ...
                              <div className="absolute bottom-6 left-1/2 -translate-x-1/2 flex items-center gap-1.5 bg-black/90 px-3 py-1 rounded-full border border-amber-500/60 shadow-[0_0_18px_rgba(249,115,22,0.9)] animate-pulse">
                                <span className="w-2.5 h-2.5 rounded-full bg-amber-500 shadow-[0_0_12px_#f97316]" />
                                <span className="text-[9px] font-bold text-amber-300 font-mono">LED VERMELHO LIGADO</span>
                              </div>
                            </div>
                          </div>
                      ...
                      kettleOfficeVariant === 'office_unboxing' ? (
                        ...
                        <div className="relative w-full h-full overflow-hidden bg-amber-950">
                          ...
                          <div className="absolute inset-0 flex flex-col items-center justify-center p-4">
                            <div className="relative w-60 h-60 rounded-3xl bg-amber-900/30 backdrop-blur-md border border-amber-500/30 flex flex-col items-center justify-center p-3 shadow-2xl">
                              ...
                              />
                              {/* Red LED glowing light on base */}
                              <div className="mt-2 flex items-center gap-1.5 bg-black/90 px-3 py-1 rounded-full border border-amber-500/60 shadow-[0_0_18px_rgba(249,115,22,0.9)] animate-pulse">
                                <span className="w-2.5 h-2.5 rounded-full bg-amber-500 shadow-[0_0_12px_#f97316]" />
                                <span className="text-[9px] font-bold text-amber-300 font-mono">LED VERMELHO LIGADO</span>
                              </div>
                            </div>
                        ...
                        <div className="relative w-full h-full overflow-hidden bg-slate-900">
                          ...
                          {/* Kettle overlay */}
                          <div className="absolute inset-0 flex flex-col items-center justify-center p-4">
                            <div className="relative w-60 h-60 rounded-3xl bg-slate-900/40 backdrop-blur-md border border-orange-500/30 flex flex-col items-center justify-center p-3 shadow-2xl">
                              <img
                                src={kettleInoxImg}
                                alt="Chaleira Inox"
                                className="w-44 h-44 object-contain rounded-full drop-shadow-[0_20px_35px_rgba(0,0,0,0.9)]"
                          ...
                          {/* Top Scene Label */}
                          <div className="absolute top-12 left-3 right-3 bg-black/85 backdrop-blur-md p-2.5 rounded-2xl border border-orange-500/30 text-center shadow-xl">
                            <span className="text-[10px] font-bold text-orange-300 uppercase tracking-wider block">
                      ...
                      kettleGamerVariant === 'gamer_rgb' ? (
                        ...
                        <div className="relative w-full h-full overflow-hidden bg-slate-950">
                          ...
                          <div className="absolute inset-0 bg-gradient-to-t from-orange-950/60 via-black/40 to-orange-950/40" />

                          {/* Gamer Keyboard & PC Case Glow background elements */}
                          <div className="absolute top-1/4 right-4 w-32 h-32 rounded-full bg-orange-500/20 blur-2xl animate-pulse" />
                          <div className="absolute bottom-1/3 left-4 w-32 h-32 rounded-full bg-orange-500/20 blur-2xl animate-pulse" />

                          {/* Kettle overlay on black gamer desk */}
                          <div className="absolute inset-0 flex flex-col items-center justify-center p-4">
                            <div className="relative w-60 h-60 rounded-3xl bg-slate-900/60 backdrop-blur-md border border-orange-500/40 flex flex-col items-center justify-center p-3 shadow-[0_0_30px_rgba(168,85,247,0.3)]">
                              <img
                                src={kettleInoxImg}
                              ...
                              />
                              {/* Red LED glowing light on base */}
                              <div className="mt-2 flex items-center gap-1.5 bg-black/90 px-3 py-1 rounded-full border border-amber-500/80 shadow-[0_0_20px_rgba(249,115,22,1)] animate-pulse">
                                <span className="w-2.5 h-2.5 rounded-full bg-amber-500 shadow-[0_0_12px_#f97316]" />
                                <span className="text-[9px] font-bold text-amber-300 font-mono">LED VERMELHO LIGADO</span>
                              </div>
                            </div>
                          ...
                          {/* Top Scene Label */}
                          <div className="absolute top-12 left-3 right-3 bg-black/85 backdrop-blur-md p-2.5 rounded-2xl border border-orange-500/40 text-center shadow-xl">
                            <span className="text-[10px] font-bold text-orange-300 uppercase tracking-wider block">
                        ...
                        <div className="relative w-full h-full overflow-hidden bg-slate-950">
                          ...
                          <div className="absolute inset-0 bg-gradient-to-t from-orange-950/60 via-black/30 to-amber-950/40" />

                          {/* Kettle overlay */}
                          <div className="absolute inset-0 flex flex-col items-center justify-center p-4">
                            <div className="relative w-60 h-60 rounded-3xl bg-slate-900/60 backdrop-blur-md border border-orange-500/40 flex flex-col items-center justify-center p-3 shadow-[0_0_30px_rgba(249,115,22,0.3)]">
                              <img
                                src={kettleInoxImg}
                                alt="Chaleira Inox Gamer"
                                className="w-44 h-44 object-contain rounded-full drop-shadow-[0_20px_35px_rgba(0,0,0,0.95)]"
                    ...
                    >
                      <div className="w-16 h-16 rounded-full bg-orange-500/80 backdrop-blur-md text-white flex items-center justify-center border border-white/30 shadow-2xl">
                    ...
                    <div className="absolute bottom-4 left-4 right-4 space-y-3 z-10">
                      <div className="bg-white/10 backdrop-blur-xl p-3 rounded-2xl border border-white/20 flex items-center gap-2.5 shadow-lg">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <p className="text-[10px] text-orange-300 font-medium">Comprar com desconto exclusivo</p>
                        </div>
                      </div>

                      <div className="space-y-1 text-white">
                        <p className="text-xs font-bold flex items-center gap-1.5">
                          @influencer_ia <CheckCircle2 className="w-3.5 h-3.5 text-amber-400 fill-amber-400" />
                        </p>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="space-y-2">
                      ...
                      <p className="text-sm text-slate-300">
                        Cenário: <strong className="text-orange-300">{activeScenarioObj.title}</strong> | Voz: <strong className="text-orange-300">{voiceAi.toUpperCase()}</strong>
                      </p>
                    </div>

                    {/* SPECIAL SELECTOR SWITCHER FOR KETTLE VIDEOS (UM OU OUTRO) */}
                    {isSpecialKettleMarble && (
                      <div className="hidden bg-slate-900/90 border border-orange-500/30 p-4 rounded-2xl space-y-3 shadow-xl">
                        <div className="flex items-center gap-2">
                        ...
                        <div className="grid grid-cols-2 gap-2.5">
                          <button
                            ...
                            className={`p-3 rounded-xl text-xs font-bold transition-all flex items-center justify-center gap-2 border ${
                              kettleMarbleVariant === 'white_marble'
                                ? 'bg-gradient-to-r from-orange-500 to-amber-500 text-white border-white/40 shadow-[0_0_15px_rgba(249,115,22,0.4)] scale-[1.02]'
                    ...
                    {isSpecialKettleOffice && (
                      <div className="hidden bg-slate-900/90 border border-amber-500/30 p-4 rounded-2xl space-y-3 shadow-xl">
                        ...
                        <div className="grid grid-cols-2 gap-2.5">
                          ...
                          >
                            <span className="w-2.5 h-2.5 rounded-full bg-orange-400 border border-orange-200" />
                      ...
                      <div className="hidden bg-slate-900/90 border border-orange-500/30 p-4 rounded-2xl space-y-3 shadow-xl">
                        ...
                        <div className="grid grid-cols-2 gap-2.5">
                          <button
                            ...
                            className={`p-3 rounded-xl text-xs font-bold transition-all flex items-center justify-center gap-2 border ${
                              kettleGamerVariant === 'gamer_rgb'
                                ? 'bg-gradient-to-r from-orange-600 to-indigo-600 text-white border-white/40 shadow-[0_0_15px_rgba(168,85,247,0.4)] scale-[1.02]'
                                : 'bg-white/5 text-slate-300 hover:text-white border-white/10 hover:bg-white/10'
                            }`}
                          >
                            <span className="w-2.5 h-2.5 rounded-full bg-orange-400 border border-orange-200" />
                          ...
                          <button
                            ...
                            className={`p-3 rounded-xl text-xs font-bold transition-all flex items-center justify-center gap-2 border ${
                              kettleGamerVariant === 'gamer_cyberpunk'
                                ? 'bg-gradient-to-r from-orange-500 to-amber-700 text-white border-white/40 shadow-[0_0_15px_rgba(249,115,22,0.4)] scale-[1.02]'
                                : 'bg-white/5 text-slate-300 hover:text-white border-white/10 hover:bg-white/10'
                            }`}
                          >
                            <span className="w-2.5 h-2.5 rounded-full bg-orange-400 border border-orange-200" />
                    ...
                    <div className="glass-panel p-6 rounded-[2.2rem] space-y-5 border border-white/15 shadow-xl">
                      <h4 className="text-xs font-bold text-slate-400 uppercase tracking-widest flex items-center gap-2">
                        <Zap className="w-4 h-4 text-orange-400" /> Ações do Criativo
                      </h4>
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <button
                          ...
                          className={`w-full py-4 px-6 rounded-2xl font-bold text-sm md:text-base flex items-center justify-center gap-3 transition-all shadow-lg active:scale-95 ${
                            downloadSuccess
                              ...
                              : 'bg-gradient-to-r from-orange-500 via-amber-500 to-amber-600 hover:opacity-90 text-white shadow-[0_0_20px_rgba(249,115,22,0.4)] border border-white/20'
                          }`}
                        >
                          {isDownloading ? (
                            <>
                        ...
                        <div className="relative">
                          <button
                            ...
                            className="w-full py-4 px-6 rounded-2xl font-bold text-sm md:text-base glass-button text-white flex items-center justify-center gap-3 transition-all active:scale-95 border border-orange-400/40 hover:bg-orange-500/20 shadow-md"
                          >
                            {isExtending ? (
                              <>
                                <Wand2 className="w-5 h-5 text-orange-400 animate-spin" /> Estendendo Duração...
                              </>
                            ) : (
                              <>
                                <Maximize2 className="w-5 h-5 text-orange-400" /> Estender Vídeo
                              </>
                            )}
                          </button>
                          ...
                          {extendOptionsOpen && (
                            ...
                            >
                              ...
                              <button
                                ...
                                className="w-full text-left p-2.5 rounded-xl text-xs font-bold text-white hover:bg-orange-500/20 hover:text-orange-300 transition-colors flex items-center justify-between"
                              >
